...
import HindiProgramSection from "./HindiProgramSection";
import HindiCoursesSlider from "./HindiCoursesSlider";
...
const Hindi = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://langmainternational.com/api/language-page/hindi-language-classes`
    )
      .then((res) => res.json())
      .then((data) => {

...
useEffect(() => {
  fetch("https://langmainternational.com/api/languages")
    .then((res) => res.json())
    .then((data) => {
 ...
 useEffect(() => {
  ...
  const fetchLanguage = async () => {
    try {
      const res = await fetch(
        `https://langmainternational.com/api/language-page/${slug}`
      );
  ...
  <meta
    name="description"
    content={languageData?.seo_description}
  />

  <meta
    name="keywords"
    content={languageData?.seo_keyword}
  />
</Helmet>
      {/* ================= BANNER ================= */}
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative flex justify-end items-center">
              ...
              <div className="absolute bottom-10 left-34 rounded-xl   ">
                ...
                <img src="/langma/images/fh.svg" alt="" />

...
import JapaneseProgramSection from "./JapaneseProgramSection";
import JapaneseCoursesSlider from "./JapaneseCoursesSlider";
...
const Japanese = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://langmainternational.com/api/language-page/online-japanese-language-course`
    )
      .then((res) => res.json())
      .then((data) => {
      ...
      <section className="w-full bg-[#f4fbfb] py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 flex justify-center">
            <img
              src={languageData?.image || "/langma/images/default.jpg"}

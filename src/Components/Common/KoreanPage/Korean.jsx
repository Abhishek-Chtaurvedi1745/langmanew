...
import KoreanProgramSection from "./KorianProgramSection";
import KoreanCoursesSlider from "./KorianCoursesSlider";
...
const Korean = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://langmainternational.com/api/language-page/online-korean-language-courses`
    )
      .then((res) => res.json())
      .then((data) => {

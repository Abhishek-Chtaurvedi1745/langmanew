...
const blogs = [
  {
    id: 1,
    image: "/langma/images/cse.svg",
    title: "Computer Science",
  },
  {
    id: 2,
    image: "/langma/images/Ai.svg",
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div className="w-full grid grid-cols-1 h-[150px] md:h-[300px] lg:h-[400px] xl:h-[600px]">
          <div
            ...
            style={{
              backgroundImage: "url('/langma/images/amr1.svg')",
  ...
  />
        ...
        <div className="w-full lg:w-1/2 text-left mt-20 lg:mt-0">
          ...
          <h2 className="text-[#296166] text-[32px] lg:text-[32px] font-semibold leading-snug mb-4">
            Study in North America with
Langma
          </h2>

          <p className="text-[#212529] text-[18px] lg:text-[16px] leading-relaxed mb-4">
            The USA and Canada are globally recognized for academic
excellence, research innovation, and strong job markets.
          </p>
...
Work Programs
  ...
  <div className="mx-auto w-full xl:w-[50%] px-4">

    <div className="flex bg-[#212529] rounded md:rounded-[113px]
                    items-center justify-center py-8 md:py-0">
      ...
      <div className="flex flex-col sm:flex-row 
        ...
        <img
          src="/langma/images/ac1.svg"
          alt="icon-1"
          className="h-[140px] sm:h-[180px] lg:h-[220px] object-contain"
        />

        <img
          src="/langma/images/ac2.svg"
          alt="icon-2"
          className="h-[140px] sm:h-[180px] lg:h-[220px] object-contain"
        />

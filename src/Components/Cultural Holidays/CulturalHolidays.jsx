...
const trips = [
  {
    ...
    image: "/langma/images/re1.png",
  },
  {
    title: "Turkey 10D Group Experience",
    image: "/langma/images/rt.png",
  },
  {
    title: "Egypt – Cruising the Nile",
    image: "/langma/images/re.png",
  },
  {
    title: "Oman",
...
const places = [
  ...
  },
  {
    ...
    tag: "Ladakh 2026",
    image: "/langma/images/ladak.jpg",
  },
  {
    title: "Spiti Valley",
    tag: "Offer",
    image: "/langma/images/ssp.jpg",
  },
  {
    title: "Arunachal Pradesh",
    tag: "Recommended",
    image: "/langma/images/ap.jpg",
  },
  {
    title: "Mizoram",
    tag: "New",
    image: "/langma/images/mz.jpg",
  },
  {
    title: "Kashmir",
    tag: "Move Loved",
    image: "/langma/images/ks.jpg",
  },
  {
    title: "Meghalaya",
    tag: " ",
    image: "/langma/images/mgh.jpg",
  },
];
      ...
      <section className="relative w-full overflow-hidden bg-[#F7FAFC]">
        <div onClick={() => setOpen(!open)} className="w-full  grid grid-cols-1 h-[150px] md:h-[300px] lg:h-[400px] xl:h-[600px]">
          <div
            ...
            style={{
              backgroundImage: "url('/langma/images/clh.png')",

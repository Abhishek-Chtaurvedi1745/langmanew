...
const API_URL = "https://langmainternational.com/api/blog-list";
  ...
  <div
    ...
    style={{
      backgroundImage: "url('/langma/images/blg.png')", 
  ...
  >
    ...
    <div className="bg-gray-50 min-h-screen py-10 px-4 md:px-10 max-w-7xl mx-auto">

...
function Event() {
  ...
  const blogs = [
    { id: 1, image: "/langma/images/ue1.png" },
    { id: 2, image: "/langma/images/ue2.png" },
    { id: 3, image: "/langma/images/ue3.png" },
    { id: 4, image: "/langma/images/ue4.png" },
    { id: 5, image: "/langma/images/ue5.png" },
    { id: 6, image: "/langma/images/ue6.png" },
    { id: 7, image: "/langma/images/ue7.png" },
    { id: 8, image: "/langma/images/ue8.png" },
    { id: 9, image: "/langma/images/ue9.png" },

    // 👉 Add more images here
    { id: 10, image: "/langma/images/10.webp" },
    { id: 11, image: "/langma/images/11.webp" },
    { id: 12, image: "/langma/images/12.webp" },
    { id: 13, image: "/langma/images/13m.webp" },
    { id: 14, image: "/langma/images/14.webp" },
    { id: 15, image: "/langma/images/15.webp" },
    { id: 16, image: "/langma/images/16.webp" },
    { id: 17, image: "/langma/images/17.webp" },
    { id: 18, image: "/langma/images/18.webp" },
    { id: 19, image: "/langma/images/19.webp" },
    // { id: 12, image: "/langma/images/12.webp" },
  ];
...
{/* <img src="/langma/images/ent1.jpg" className="absolute inset-0 w-full h-full object-cover" alt="" /> */}
...
<section className="w-full py-10 lg:py-20 overflow-hidden relative">
  ...
  <div className="absolute inset-0 z-0 opacity-50 pointer-events-none">
    {/* <div className="max-w-7xl mx-auto h-full flex justify-between">
      {[...Array(14)].map((_, i) => (
        <div
          key={i}
          className="w-[2px] h-full bg-[#efcfcf]"
        ></div>
      ))}
    </div> */}
  </div>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-10 items-center">
    ...
    <div>
      ...
      <p className="text-[#212529] text-lg mb-2">
      ...
      <div className="space-y-6">
        ...
        {/* Mission */}
        {/* <div className="bg-[#f9cfcf]/70 backdrop-blur-sm rounded-[24px] p-6 shadow-sm border border-[#f2baba]">
          <h3 className="text-[#e53935] font-bold text-3xl mb-3 uppercase">
            Our Mission
          </h3>
...
<div className="flex justify-center lg:justify-end mt-4 lg:mt-[236px]">
  ...
  <div className="relative rounded-[28px] overflow-hidden shadow-2xl w-full h-[333px] group cursor-pointer border border-[#222]">

    {/* GOOGLE DRIVE VIDEO */}
    {/* <iframe
      src="https://drive.google.com/file/d/1IUcewNENza4_8Fp9RtNk2gbl2YoLjHUJ/preview"
      width="100%"
      height="100%"
      allow="autoplay"
    ...
    <img src="/langma/images/abtp.jpg" className="w-full h-full object-cover" alt="" />
          ...
          {visibleCount < blogs.length && (
            <div className="text-center mt-8">
              <button
                ...
                className="bg-[#2FC7A1] text-white px-6 py-2 rounded-full cursor-pointer"
              >
                Load More
              </button>
            </div>

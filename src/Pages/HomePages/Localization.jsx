...
function Localization() {
  ...
  style={{
    backgroundImage: "url('/langma/images/lz1.jpg')",
  }}
>
</div>
      <ConnectedSection/>
...
{/* 
        ...
        <h3 className="text-[32px] text-[#296166] font-semibold mb-3">
         WE OFFER LOCALIZATION SERVICES FOR:
        </h3>
...
transcription services for</p> */}
        ...
        <div className="grid md:grid-cols-2 gap-6 text-[#212529] text-[18px]">
          <ul className="list-decimal pl-5 space-y-2">
            ...
            <li>Training and Study Materials</li>
            <li>Subtitles and Graphics</li>
          </ul>
        ...
        {/* Footer Text */}
        <h2 className="text-[32px] mt-3 font-bold text-[#296166] mb-2">
             Contact our experts today!
          </h2>
        <p className='text-[18px] text-[#212529]  mb-2'>
          Langma International can provide localization services in all major languages of the world which includes German, Arabic, Spanish, etc. Whether you are looking to enter the Chinese market or the developing market of South America or the developed markets of Europe, our team of translators is here to help you in localizing your business!
        </p>
        <p>Are you ready to get started to hit the global market? Get your website content localized by our linguistic team and attracts the local audience! Please feel free to contact us at any time with your request!</p>
